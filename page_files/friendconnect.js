...
var friendconnect_serverVersion = "0.1-4b76bd44_0abfbe4c_a2f0d73d_c53d87c5_3993c13c.7";
...
if(0<b){for(var c=fcf(b),d=0;d<b;d++)c[d]=a[d];return c}return[]},fc$a=function(a,b,c){fc4a(null!=a[fcI]);return 2>=arguments[fcI]?fc5a[fcE][fcM](a,b):fc5a[fcE][fcM](a,b,c)};var fcab=function(a,b,c){for(var d in a)b[fcM](c,a[d],d,a)},fcbb=function(a){var b=[],c=0,d;for(d in a)b[c++]=a[d];return b},fccb=function(a){var b=[],c=0,d;for(d in a)b[c++]=d;return b},fcdb="constructor hasOwnProperty isPrototypeOf propertyIsEnumerable toLocaleString toString valueOf".split(" "),fceb=function(a,b){for(var c,d,e=1;e<arguments[fcI];e++){d=arguments[e];for(c in d)a[c]=d[c];for(var f=0;f<fcdb[fcI];f++)c=fcdb[f],fcaa[fc].hasOwnProperty[fcM](d,c)&&(a[c]=d[c])}};var fcfb=function(){var a=fcP.navigator;return a&&(a=a.userAgent)?a:""},fcgb=fcfb(),fcV=function(a){var b=fcgb;return-1!=b[fcG](a)},fchb=function(a){var b=fcgb;return-1!=b[fcBa]()[fcG](a[fcBa]())};var fcib=function(){return fcV("Opera")||fcV("OPR")},fcjb=function(){return fcV("Trident")||fcV("MSIE")},fckb=fcib,fclb=fcjb;var fcmb=fckb(),fcW=fclb(),fcnb=fcV("Gecko")&&!fchb("WebKit")&&!(fcV("Trident")||fcV("MSIE")),fcob=fchb("WebKit"),fcqb=function(){var a="",b;if(fcmb&&fcP.opera)return a=fcP.opera.version,"function"==fcEa(a)?a():a;fcnb?b=/rv\:([^\);]+)(\)|;)/:fcW?b=/\b(?:MSIE|rv)[: ]([^\);]+)(\)|;)/:fcob&&(b=/WebKit\/(\S+)/);b&&(a=(a=b.exec(fcgb))?a[1]:"");return fcW&&(b=fcpb(),b>parseFloat(a))?fci(b):a},fcpb=function(){var a=fcP[fcJ];return a?a.documentMode:void 0},fcrb=fcqb(),fcsb={},fctb=function(a){return fcsb[a]||
(fcsb[a]=0<=fcYa(fcrb,a))},fcub=function(){var a=fcP[fcJ];if(a&&fcW){var b=fcpb();return b||("CSS1Compat"==a.compatMode?fcca(fcrb,10):5)}}();var fcvb=function(a){for(var b=[],c=0,d=0;d<a[fcI];d++){for(var e=a[fcya](d);255<e;)b[c++]=e&255,e>>=8;b[c++]=e}return b};var fcwb=null,fcxb=null,fcyb=null,fczb=null,fcBb=function(a,b){if(!fcFa(a))throw fch("encodeByteArray takes an array as a parameter");fcAb();for(var c=b?fcyb:fcwb,d=[],e=0;e<a[fcI];e+=3){var f=a[e],k=e+1<a[fcI],l=k?a[e+1]:0,m=e+2<a[fcI],n=m?a[e+2]:0,g=f>>2,f=(f&3)<<4|l>>4,l=(l&15)<<2|n>>6,n=n&63;m||(n=64,k||(l=64));d[fcC](c[g],c[f],c[l],c[n])}return d[fcO]("")},fcCb=function(a,b){fcAb();for(var c=b?fczb:fcxb,d=[],e=0;e<a[fcI];){var f=c[a[fcp](e++)],k=e<a[fcI],k=k?c[a[fcp](e)]:0;++e;var l=e<a[fcI],
l=l?c[a[fcp](e)]:64;++e;var m=e<a[fcI],m=m?c[a[fcp](e)]:64;++e;if(null==f||null==k||null==l||null==m)throw fch();f=f<<2|k>>4;d[fcC](f);64!=l&&(f=k<<4&240|l>>2,d[fcC](f),64!=m&&(f=l<<6&192|m,d[fcC](f)))}return d},fcAb=function(){if(!fcwb){fcwb={};fcxb={};fcyb={};fczb={};for(var a=0;65>a;a++)fcwb[a]="ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/="[fcp](a),fcxb[fcwb[a]]=a,fcyb[a]="ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789-_."[fcp](a),fczb[fcyb[a]]=a,62<=a&&(fcxb["ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789-_."[fcp](a)]=
a,fczb["ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/="[fcp](a)]=a)}};var fcDb=function(){this.blockSize=-1};var fcX=function(a,b,c){fcDb[fcM](this);this.i=a;this.blockSize=c||a.blockSize||16;this.Xb=fcf(this.blockSize);this.Va=fcf(this.blockSize);this.Tb(b)};fcU(fcX,fcDb);fcX[fc].Tb=function(a){a[fcI]>this.blockSize&&(this.i[fcN](a),a=this.i.digest(),this.i[fcpa]());for(var b,c=0;c<this.blockSize;c++)b=c<a[fcI]?a[c]:0,this.Xb[c]=b^92,this.Va[c]=b^54;this.i[fcN](this.Va)};fcX[fc].reset=function(){this.i[fcpa]();this.i[fcN](this.Va)};fcX[fc].update=function(a,b){this.i[fcN](a,b)};
fcX[fc].digest=function(){var a=this.i.digest();this.i[fcpa]();this.i[fcN](this.Xb);this.i[fcN](a);return this.i.digest()};fcX[fc].Jb=function(a){this[fcpa]();this[fcN](a);return this.digest()};var fcY=function(){fcDb[fcM](this);this.blockSize=64;this.c=[];this.Ca=[];this.Ic=[];this.sa=[];this.sa[0]=128;for(var a=1;a<this.blockSize;++a)this.sa[a]=0;this.ya=this.G=0;this[fcpa]()};fcU(fcY,fcDb);fcY[fc].reset=function(){this.c[0]=1732584193;this.c[1]=4023233417;this.c[2]=2562383102;this.c[3]=271733878;this.c[4]=3285377520;this.ya=this.G=0};
...
fc1[fc].get=function(a,b){return fcXb(this.j,a)?this.j[a]:b};fc1[fc].set=function(a,b){fcXb(this.j,a)||(this.v++,this.e[fcC](a),this.$++);this.j[a]=b};fc1[fc].ob=function(a){var b;a instanceof fc1?(b=a.r(),a=a.F()):(b=fccb(a),a=fcbb(a));for(var c=0;c<b[fcI];c++)this.set(b[c],a[c])};fc1[fc].forEach=function(a,b){for(var c=this.r(),d=0;d<c[fcI];d++){var e=c[d],f=this.get(e);a[fcM](b,f,e,this)}};fc1[fc].clone=function(){return new fc1(this)};
fc1[fc].__iterator__=function(a){this.K();var b=0,c=this.e,d=this.j,e=this.$,f=this,k=new fcWb;k.next=function(){for(;;){if(e!=f.$)throw fch("The map has changed since the iterator was created");if(b>=c[fcI])throw fcVb;var k=c[b++];return a?k:d[k]}};return k};var fcXb=function(a,b){return fcaa[fc].hasOwnProperty[fcM](a,b)};var fcZb=function(a,b,c){fcQ(b)?fcYb(a,c,b):fcab(b,fcJa(fcYb,a))},fcYb=function(a,b,c){(c=fc_b(a,c))&&(a[fcw][c]=b)},fc_b=function(a,b){var c=fcZa(b);if(void 0===a[fcw][c]){var d=(fcob?"Webkit":fcnb?"Moz":fcW?"ms":fcmb?"O":null)+fc_a(c);if(void 0!==a[fcw][d])return d}return c},fc0b=function(a,b){var c=fcUb(a);return c.defaultView&&c.defaultView.getComputedStyle&&(c=c.defaultView.getComputedStyle(a,null))?c[b]||c.getPropertyValue(b)||"":""},fc1b=function(a,b){return fc0b(a,b)||(a.currentStyle?a.currentStyle[b]:
...
fc3[fc].da=function(a){fceb(this.constraints,a||{});fceb(this.skin,this.constraints);if(this.bar.fixedIeSizes&&this.constraints[fcta]&&this.constraints[fcqa]){a=this.bar.Cb();var b=this.constraints[fcta],c=this.constraints[fcqa];a-=b+c;a%2&&(a-=1,this.skin.right=this.skin[fcqa]+1);fcj(this.skin,a);delete this.skin[fcta]}};
...
fc9[fc].ub=function(a){var b=new fcY;a=fcvb(a);b[fcN](a);b=b.digest();return b=fcwc(b)};
...
fc5[fc].signout=function(a){fc4.$a(fc4.ea(a));fc4.$a(fc4.ka(a));fc4.Ga={};fc4.U();return!1};fc9[fc].$a=function(a){for(var b=fce[fcv].pathname,b=b[fcu]("/"),c=0;c<b[fcI];c++){for(var d=fcf(c+1),e=0;e<c+1;e++)d[e]=b[e];fcFb.remove(a,d[fcO]("/")+"/")}};
...
google.friendconnect.container.setDateStamp_('148a9489784');